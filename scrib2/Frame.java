...
//            }}
    ...
    private void btnBoldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBoldActionPerformed
       ...
       ///textPane.getSelectedText().setFont(boldFont);
       ///StyleConstants.setBold(a, rootPaneCheckingEnabled);
       ...
       //textPane.setFont(new Font(textPane.getFont().getName(),Font.BOLD,textPane.getFont().getSize()));
       
      
       
       
       //textField.getSelectedText().setFont(boldFont);
       //StyleConstants.setBold(a, rootPaneCheckingEnabled);
//       final Style style = textField.addStyle("Bold", null);
//        StyleConstants.setBold(style, true);
//       textField.getSelectedText().
//       String thisText = textField.getSelectedText();
//       String boldText = thisText.
//      textField.getSelectedText()
//               replaceAll(thisText);
//       textField.
